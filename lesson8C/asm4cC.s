...
.importzp _pointer, _pointer2, _copy_length
.export _Get_Input, _Wait_Vblank, _UnRLE, _Even_Faster_Copy
...
;_pointer = source address
;_pointer2 = destination address
;copy_length = number of bytes to move
_Even_Faster_Copy:
	ldy #0
:
	lda (_pointer), y
	...
	bne :-
	rts
;if _copy_length is zero, will do 256 byte transfer
